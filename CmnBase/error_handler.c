/*
Common error-handling functions for C programs. Reference from Linux Programming Interface
*/
#include <stdio.h>
#include <stdlib.h>
#include <stdarg.h>
...
void terminate(int status, bool useExit3)
{
    ...
    if (s != NULL && *s != '\0')
        ...
        //Use _exit() to terminate process immediately without calling any cleanup function
        _exit(status);
}